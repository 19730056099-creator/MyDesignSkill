    ...
    <main>
      <nav className="nav">
        ...
        <div className="nav-links">
          ...
          <a className="github-link" href="#" rel="noreferrer">开源项目 ↗</a>
        </div>
      </nav>

      <section className="hero workbench-hero" id="top">
        <div className="hero-copy">
          <div className="eyebrow"><span /> 真实课程验证 · 通用开源 Skill</div>
          ...
          <p className="microcopy">约两周 · 多门课程 90+ · 真实大学课程为验证场景，非学校官方项目</p>
        </div>
      ...
      <section className="case-section">
        <div><p className="kicker">REAL CASE / 真实课程验证</p><h2>90+ 不是一句口号，<br />而是一段被复盘的过程。</h2><p>方法源自真实大学经济学课程的约两周期末冲刺。人机协作从“帮我整理重点”，逐步迭代为考试约束识别、材料证据排序、往年题反推、采分模板、变式训练和考前收口。</p><small>真实课程期末考为验证场景。本项目非任何学校官方项目，也不公开校内课件或未授权试题。</small></div>
